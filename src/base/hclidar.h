...
private:
    ...
    std::mutex               m_mtxT2Stared;
    std::condition_variable  m_cvT2Started;
    bool                     m_bT2Stared {false};
...
private:
    ...
    bool getT2SNInfo(std::vector<UCHAR>& lstBuff);
    ...
    void sendGetT2LidarInfoCommand();
};

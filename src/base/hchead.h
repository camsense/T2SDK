...
#define  FPS_5000_MIN                   (FPS_5000_NOR-FPS_5000_RANGE)
#define  FPS_5000_MAX                   (FPS_5000_NOR+FPS_5000_RANGE)
...
#define  ANGLE_RESOLVE_5000_6HZ         0.432
...
#define  CIRCLE_MAX_5000_6HZ            833
...
typedef struct tsSDKSNT200{
    ...
    UCHAR   u8ProType[4];
    UCHAR   u8Reserve1[4];
    UCHAR   u8FirmwareVer[4];
    UCHAR   u8Reserve2[7];
    UCHAR   u8HardwareVer[4];
    UCHAR   u8Reserve3[8];
    UCHAR   u8SN[20];
}tsSDKSNT200;
